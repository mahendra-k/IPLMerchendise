        ...
        public async Task<int> AddAsync(Order order)
        {
            ...
            try
            {
                ...
                var orderQuery = @"INSERT INTO [Order] (UserId, TotalAmount,Status,CurrencyCode ) 
                               VALUES (@UserId, @TotalAmount,@Status,@CurrencyCode);
                ...
                {
                    var orderItemQuery = @"INSERT INTO OrderItem (OrderId, ProductId, Quantity, Price,CurrencyCode) 
                                       VALUES (@OrderId, @ProductId, @Quantity, @Price,@CurrencyCode);";
